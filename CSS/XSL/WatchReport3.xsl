...
<xsl:variable name="href-val_report-head__marquee-img-src">
  <xsl:value-of select="string('https://lonebuffalo.secure.footprint.net/graphics/lbNLHeader.jpg')" />
</xsl:variable>
...
<xsl:variable name="href-val__service-branding-img-src">
  <xsl:value-of select="string('https://lonebuffalo.secure.footprint.net/graphics/lbNLbottomBrand.png')" />
</xsl:variable>
...
<xsl:variable name="href-val_fulltext__block-copyright-img-src">
  <xsl:value-of select="string('https://lonebuffalo.secure.footprint.net/graphics/DJbranding.png')" />
</xsl:variable>
