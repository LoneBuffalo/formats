...
<xsl:template match="/">
	<form name="selectionset" action="selection.cfm" method="post" >
	<input type="hidden" name="doselect" value="0" />
	<table xsl:use-attribute-sets="table">
	<tr>
	<td align="center" class="checkboxinstructions">
		&#xa0;<b>Click the checkbox for each story you would like to display, print or email then click:</b>
	</td>
	</tr>
        <tr><td align="center">
...
<xsl:template match="ARTICLE">
	<tr class="breakinglist">
		<td valign="top" nowrap="true"><input xsl:use-attribute-sets="checkbox"/></td>
		<td>
